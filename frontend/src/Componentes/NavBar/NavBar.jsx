    ...
    <>
      <nav className="navbar navbar-expand-lg bg-body-tertiary">
        <div className="nav container-fluid">
          ...
          <button
            className="botonDelNav navbar-toggler"
            type="button"
          ...
          >
            <svg
              ...
              height="32"
              fill="currentColor"
              className="fotoimg bi bi-crosshair"
              viewBox="0 0 16 16"
            >
            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="menuEsta dropdown-menu">
                  ...
                  <li>
                    <Link
                      className="menuEstadisticas dropdown-item"
                  ...
                  <li>
                    <Link className="menuEstadisticas dropdown-item" to="Proximamente">
                      --Próximamente--
                    </Link>
                  </li>
                </ul>
